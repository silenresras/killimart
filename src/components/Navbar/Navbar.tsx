  ...
  return (
    <header className="shadow-md sticky top-0 z-50 bg-white">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b gap-4">
        ...
        <div className="flex-1 w-full md:w-auto">
          <div className="relative w-full">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center">
              <button
                type="submit"
                className="h-full px-4 bg-emerald-500 rounded-r-md hover:bg-emerald-600 transition-colors"
              >
        ...
        {/* Icons for Desktop */}
        <div className="hidden md:flex gap-4 items-center text-gray-700 text-lg whitespace-nowrap">
            ...
            <div className="p-4 overflow-y-auto max-h-full flex-1">
              ...
              <div className="mt-6">
                ...
                <div className="flex flex-col gap-2">
                  <Link href="/category/laptops" className="hover:text-red-500   hover:underline" onClick={() => setMenuOpen(false)}>Laptops</Link>
